			...
			<tbody>
			   <%					 
					   try
					   {
						...
						ResultSet rs = st.executeQuery("select * from contact where isRead is null");
						int i =0;
						while(rs.next())
						{
							i++;
					  %>
					   ...
					   <td><a href="viewEnquiryDtls.jsp?cid=<%=rs.getInt("cid") %>" class="btn btn-sm btn-primary">View Details</a></td>
					  </tr> 
					  <% 		
						}
					  }
