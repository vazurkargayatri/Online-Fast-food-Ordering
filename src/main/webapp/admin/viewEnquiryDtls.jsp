...
<div class="container card shadow m-5">
	<div class="card-body">
	<h5 class="p-2" style="border-bottom: 2px solid orange">View Enquiry Details</h5>
		    ...
		    <h1 class="text-success text-center"></h1>		
                   ...
                   int cid = Integer.parseInt(request.getParameter("cid"));
						try {
							...
							ResultSet rs = st.executeQuery("select * from contact where cid="+cid+"");
						    while (rs.next()) {								
					%>
			        			  
					<table border="1" class="table table-bordered mg-b-0">
						<tr>
						  <th colspan="4" style="text-align: center; font-size: 22px; color: red;">View Enquiry Details</th>
						</tr>
						<tr>
							<th>Name</th>
                   ...
                   try{
                	   ...
                	   st1.executeUpdate("update contact set isRead='yes' where cid="+cid+"");
